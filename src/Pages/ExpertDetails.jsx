    ...
    return (
        ...
        <>
            ...
            <HStack justifyContent={"center"} borderBottom="1px solid #cccfcd" p={5} w="100%">
                <Box w="60%" height={{ base: 'auto', md: '100%' }} p={5}>
                    ...
                    <Box mt={5} borderRadius={{ base: 'none', md: 'md' }} bg="gray.100" p={5}>
                        <Flex justifyContent={"space-between"} align="center" mt={2}>
                            ...
                            <Box borderLeft={{ base: 'none', md: '1px solid #cccfcd' }} pl={5} w="70%">
                                <Text fontSize="xl" color={useColorModeValue('gray.600', 'gray.400')}>
                    ...
                    <Box mt={5} borderRadius={{ base: 'none', md: 'md' }} bg="gray.50" p={5}>
                        <Tabs variant='unstyled'>
                            ...
                            <TabPanels>
                                ...
                                <TabPanel p={4} minH="200px"> {/* Set minimum height */}
                                    <SimpleGrid color={"gray.600"} columns={[2, 2]}>
                                        <Box align="center" borderRight={{ base: 'none', md: '1px solid #cccfcd' }} borderBottom={{ base: 'none', md: '1px solid #cccfcd' }} height='80px'>
                                            <Badge colorScheme="yellow">Spécialité</Badge>
                                            <br />
                                            Nutritionniste
                                        </Box>
                                        <Box borderBottom={{ base: 'none', md: '1px solid #cccfcd' }} align="center" height='80px'>
                                            <Badge colorScheme="red">Expérience</Badge>
                                            <br />
                                            7 ans d’expérience
                                        </Box>
                                        <Box borderRight={{ base: 'none', md: '1px solid #cccfcd' }} align="center" height='80px'>
